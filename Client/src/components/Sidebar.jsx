              ...
              <ul className="flex flex-col py-4 space-y-1 ml-4 mr-5">
                    {path.map((link, index) => (
                      <li key={index}>
                        <Link
                          to={link.path}
                          className={`relative flex flex-row items-center h-11 focus:outline-none rounded-xl hover:text-white hover:bg-[#f5f7f9] hover:bg-opacity-5 bg-opacity-5 border-transparent pr-6 ${activeTab === index ? 'bg-[#f5f7f9] text-white' : 'text-gray-600'}`}
                          onClick={() => handleTabClick(index)}
                        >
                          <span className="inline-flex justify-center items-center ml-4">
                            <svg
                          ...
                          <span className={`ml-2 font-semibold hover:text-white  ${activeTab === index ? 'text-white' : 'text-zinc-500'}`}>
                            {link.name}
                          </span>
                        </Link>
                      </li>
